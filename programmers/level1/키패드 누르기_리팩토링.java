class Solution {
    ...
    public String solution(int[] numbers, String hand) {
        ...
        for(int number : numbers){
            ...
            if(columnOfNumber == Column.LEFT) leftHand.setLocation(charNumber, columnOfNumber);
            else if(columnOfNumber == Column.RIGHT) rightHand.setLocation(charNumber,columnOfNumber);
            else{
                if(leftHand.getDistance(charNumber) > rightHand.getDistance(charNumber)) rightHand.setLocation(charNumber,columnOfNumber);
                else if(leftHand.getDistance(charNumber) < rightHand.getDistance(charNumber)) leftHand.setLocation(charNumber,columnOfNumber);
                else{
                    if(hand.equals("right")) rightHand.setLocation(charNumber,columnOfNumber);
                    else leftHand.setLocation(charNumber,columnOfNumber);
                }
            }
        }
